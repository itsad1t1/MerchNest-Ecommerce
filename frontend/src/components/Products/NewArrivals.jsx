...
const NewArrivals = () => {
    ...
    <section className="py-16 px-4 lg:px-0">
        ...
        >
            ...
            {newArrivals.map((product) => (
                <div key={product._id} className="min-w-[100%] 
                sm:min-w-[50%] lg:min-w-[30%] relative">
 ...
 {product.images?.[0]?.url ? (
      ...
      <div className="w-full h-[500px] flex items-center justify-center bg-gray-100 text-gray-500 rounded-lg">
        No image available
      </div>
    )}
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-opacity-50 backdrop-blur-md text-white p-4 rounded-b-lg">
                        ...
                        <p className="mt-1">{product.price}
                        </p>
                        </Link>
                    </div>
                </div>
