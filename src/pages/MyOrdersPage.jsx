...
const handleRowClick = (orderId) => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6">
        ...
        <div className="realtive shadow-md sm:rounded-lg overflow-hidden">
                ...
                <tbody>
                    {
                        orders.length > 0 ? (
                            orders.map((order) => (
                                ...
                                <td className="py-2 px-2 sm:py-4 sm:px-4 font-medium text-gray-900 whitespace-nowrap">#{order._id}
                                </td>
                                <td className="py-2 px-2 sm:py-4 sm:px-4">
                                ...
                                <td className="py-2 px-2 sm:px-4">{order.orderItems.length}
                                </td>
                                <td className="py-2 px-2 sm:py-4 sm:px-4">
                                ${order.totalPrice}
                                </td>
